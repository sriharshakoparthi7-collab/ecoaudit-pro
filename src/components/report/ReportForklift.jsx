            ...
            <div key={fc.id} className="bg-white rounded-xl p-6 shadow-sm card-block" style={{ pageBreakInside: 'avoid', breakInside: 'avoid' }}>
              ...
              {fc.extra_notes && (
                <div style={{ marginTop: '12px', padding: '10px 14px', background: '#f0f7ee', borderLeft: '3px solid #79B44A', borderRadius: '6px' }}>
                  ...
                  <p style={{ fontSize: '9pt', color: '#333', lineHeight: 1.5 }}>{fc.extra_notes}</p>
                </div>
              )}
              {fc.energy_improvement_observations && (
                <div style={{ marginTop: '12px', padding: '10px 14px', background: '#fff8e6', borderLeft: '3px solid #f5a623', borderRadius: '6px' }}>
                  ...
                  <p style={{ fontSize: '9pt', color: '#333', lineHeight: 1.5 }}>{fc.energy_improvement_observations}</p>
                </div>
              )}
